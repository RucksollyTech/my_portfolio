...
import UnloadedPortfolio from '../UnloadedPortfolio';
...
const Home = () => {
    ...
    const [loaderIntro,setLoaderIntro] =useState(false);
    ...
    return (
        <div>
            {loaderIntro && <div className='starsBackground3'>
                <UnloadedPortfolio />
            </div>}
